 ...
 */
// export function UnwrappedLink<AsType extends ElementType>(
//   props: {
//     as?: AsType;
//   } & DistributiveOmit<
//     ComponentPropsWithRef<ElementType extends AsType ? "a" : AsType>,
//     "as"
//   >,
...
//? Again, for some reason the autocomplete still works with a default `as` prop now
export function UnwrappedLink<AsType extends ElementType = "a">(
  props: {
    as?: AsType;
  } & DistributiveOmit<ComponentPropsWithRef<AsType>, "as">,
  ref: ForwardedRef<any>
) {
  const { as: Comp = "a", ...rest } = props;
  return <Comp {...rest} ref={ref}></Comp>;
