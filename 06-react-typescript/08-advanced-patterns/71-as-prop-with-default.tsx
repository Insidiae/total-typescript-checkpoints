...
//? For some reason, the autocomplete for `as` still works!
export function Link<AsType extends ElementType = "a">(
  props: {
    as?: AsType;
...
// export function Link<AsType extends ElementType>(
//   props: {
//     as?: AsType;
//   } & React.ComponentPropsWithoutRef<ElementType extends AsType ? "a" : AsType>
// ) {
//   const { as: Comp = "a", ...rest } = props;
//   return <Comp {...rest}></Comp>;
// }
